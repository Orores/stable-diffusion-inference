...
def load_model_sd15(model_id="sd-legacy/stable-diffusion-v1-5", cache_dir="/workspace/ai_models"):
...
def generate_image_sd15(prompt, pipe, num_inference_steps=50, guidance_scale=7.5):
    """Generate an image using the Stable Diffusion v1.5 model based on the given prompt."""
...
if __name__ == "__main__":
    ...
    # Perform inference
    try:
        image = generate_image_sd15(prompt, pipe, num_inference_steps, guidance_scale)
